...
<Callout>PageIndex with Metadata support is coming sooon. Fill out this form to get early access to this function.</Callout>

---

### Description-based Document Search

For documents that can’t be easily distinguished by metadata, you can use LLM-generated descriptions to help with document selection.
