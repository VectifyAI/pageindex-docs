...
### 🔎 PageIndex Retrieval
<Callout type="info">
  Retrieval function requries a completed PageIndex tree generation.
</Callout>

<Callout type="info">
  Currently only support one document retrieval, multiple document retreival is comming soon. See also [Doc Search](/docSearch) page for docuemnt search examples.
</Callout>
