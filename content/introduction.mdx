...
Once documents are transformed into hierarchical tree structures, the PageIndex retrieval module extracts relevant context from these trees. It leverages both LLM-based tree search and value-based tree search to perform efficient and accurate retrieval. A brief overview of the tree-search strategy can be found [here](/examples/hybrid-search).
...
The PageIndex tree generation and retrieval features are now integrated into both our dashboard and API. Experience the next generation of RAG by simply uploading your documents through our dashboard:

- [Dashboard](/dashboard)  

Alternatively, our API service allows you to seamlessly integrate our RAG pipeline into your existing systems:
- [API](/quick-start)
