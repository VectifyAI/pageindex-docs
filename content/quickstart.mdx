...
<Callout type="info">
  Currently, only single-document retrieval is supported. Multi-document retrieval is coming soon. See also the [Doc Search](/doc-search) page for document search examples.
</Callout>
...
👉 See the full [API Reference](/api) for optional parameters, examples, and integration guides.
